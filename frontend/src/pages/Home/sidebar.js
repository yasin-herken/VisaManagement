...
function Sidebar({role,coll,username}) {
    ...
    if(file){
        for(let i = 0;i < file.childElementCount;i++){
            ...
            else if(file.children[i].firstChild.pathname==="/newApplication" && pathName==="/newApplication"){
                                ...
                                <div className="simplebar-content" style={{padding:"0px"}}>
                                    ...
                                    <ul className="sidebar-nav" >
                                        ...
                                        <li className="sidebar-item active" onClick={()=>Navigate("/")} >
                                            <Link data-bs-target="#dashboards" className="sidebar-link collapsed" aria-expanded="false" to="/">
                                        ...
                                        <li className="sidebar-item ">
                                            <Link  className="sidebar-link" to="/newApplication">
                                        ...
                                        {
                                            (role!=="Admin" && role!=="Client")?<li className="sidebar-item">
