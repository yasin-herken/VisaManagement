                            ...
                            <div className="simplebar-content-wrapper" tabIndex="0" role="region" aria-label="scrollable content" style={{ height: "100%", overflow: "hidden scroll" }}>
                                <div className="simplebar-content" style={{ padding: "0px" }}>
                                    ...
                                    <ul className="sidebar-nav" style={{ marginTop: "80px" }}>
                                        ...
                                        {
                                            ((user ? user.role === "Admin" || user.role === "All" : null) ?
                                        ...
                                        {
                                            ((user?.role !== "Admin") && (user?.role !== "All")) ? <li className="sidebar-item">
                                                        ...
                                                        reportsCollapse ?
                                                            <CSSTransition nodeRef={nodeRef} in={reportsCollapse} timeout={300} classNames="my-node">
                                                                <Ul active={reportsCollapse} className={`sidebar-dropdown list-unstyled ml-5`} ref={nodeRef}>
                                                                    <li className="sidebar-item">
                                                                        <Link className="sidebar-link" to="/deliveryList" >Passport Delivery List</Link>
                                                                    </li>
                                                                    <li className="sidebar-item">
